...
interface TutorProfileClientProps {
  tutorId: string
  tutorData?: any // Will be passed from server component
}

export default function TutorProfileClient({ tutorId, tutorData }: TutorProfileClientProps) {
  const [showContactForm, setShowContactForm] = useState(false)

  // Use tutorData if provided, otherwise use mock data
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  {tutor.languages.map((language: string) => (
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2 text-sm">
                  {Object.entries(tutor.availability).map(([day, slots]: [string, any]) => {
